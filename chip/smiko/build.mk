...
custom-ro_objs-y  = chip/$(CHIP)/clock.o
custom-ro_objs-y += chip/$(CHIP)/dcrypto/key_ladder.o
custom-ro_objs-y += chip/$(CHIP)/dcrypto/sha256.o
custom-ro_objs-y += chip/$(CHIP)/loader/init.o
...
custom-ro_objs-y += chip/$(CHIP)/loader/rom_uart.o
custom-ro_objs-y += chip/$(CHIP)/loader/setup.o
custom-ro_objs-y += chip/$(CHIP)/loader/verify.o
custom-ro_objs-y += chip/$(CHIP)/pmu.o
custom-ro_objs-y += chip/$(CHIP)/system.o
custom-ro_objs-y += chip/$(CHIP)/trng.o
...
CODESIGNER_PATH := $(abspath ../../test/signer)
...
$(SIGNER):
	CFLAGS="" CXX="g++" $(MAKE) -C $(CODESIGNER_PATH) codesigner
else
...
export KMS_PKCS11_CONFIG = $(abspath chip/$(CHIP)/config.yaml)
