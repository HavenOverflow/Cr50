...
common-$(CONFIG_CASE_CLOSED_DEBUG_V2)+=ccd_config_v2.o
...
$(out)/RW/common/pinweaver_eal.o: common/pinweaver_eal.c
	$(call quiet,c_to_o,CC     )
$(out)/RW/common/pinweaver.o: common/pinweaver.c
	$(call quiet,c_to_o,CC     )
endif

# Build platform/gsc-utils/dice.
ifeq ($(CONFIG_PLATFORM_BOOT_PARAM),y)
BOOT_PARAM_PATH := $(realpath boot_param)
