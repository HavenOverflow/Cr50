...
{
	/**
	 * We should NEVER update the INFO1 rollback mask in CFW, as we risk making
	 * all stock firmware unbootable. Just return and pretend something happened.
	*/
	ccprintf("Not updating rollback mask for CFW.\n");
}
